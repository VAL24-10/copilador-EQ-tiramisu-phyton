...
class MotorCompilador:
    ...
    def ejecutar_codigo(codigo_traducido):
        ...
        espacio_nombres = {}
        try:
            moulo - ast.parse(codigo_traducido)
            ...
            with contextlib.redirect_stdout(salida_consola):
                ...
                valor_final - eval(codigo_expresion, espacio_nombres) if codigo_expresion else num_linea

            salida_texto = salida_consola.getvalue().strip()
            if salida_texto and valor_finalis not None:
